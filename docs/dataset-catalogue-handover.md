...
- [ ] Add PostgreSQL integration tests proving project isolation, immutable version numbering,
...
- [ ] Add a short-lived, version-scoped preview session. Its file endpoint should validate a hashed
...
- [ ] Add audit events for dataset registration, upload completion or rejection, curation updates,
